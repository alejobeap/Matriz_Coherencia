...
#    sbatch -A comet -p comet -o sbatch_logs/$file.gapfill.out -e sbatch_logs/$file.gapfill.err -t 72:00:00 ./unwrap_geo.sh 164A_12971_071312 "$file"
     ...
     sbatch --qos=high --output=sbatch_logs/$file.out --error=sbatch_logs/$file.err --job-name=$file -n 8 --time=23:59:00 --mem=65536 -p comet --account=comet_lics --partition=standard --wrap="./unwrap_geo.sh 164A_12971_071312 $file"
  else
