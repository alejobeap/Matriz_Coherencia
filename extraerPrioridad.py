...
def get_volc_info_a2():
    ...
    con el volc_id como Ã­ndice y el nombre como primera columna.
    """
    sql = """
...
if __name__ == "__main__":
    ...
    # Save full dataframe to text file (tab-separated)
    volcanoes_a2.to_csv('volcanoes_a2_full.txt', sep='\t')

    # Save only name, lat, lon columns to another text file
    volcanoes_a2[['name', 'lon', 'lat']].to_csv('volcanoes_a2_name_lat_lon.txt', sep=' ', index=False)
